...
import com.frontend.component.collider.SphereCollider;
...
public class RedTextureBehaviour extends BaseBehaviour {
    ...
    public void onCreate() {
        ...
        this.renderAsset = new GLES2TextureAsset(this.context, "textures/texture01.png");
        this.renderAsset.create();
        this.renderAsset.transform.position = new Float3(-2.0f, 0.0f, 0.0f);
        this.collider = new SphereCollider(this.renderAsset);
