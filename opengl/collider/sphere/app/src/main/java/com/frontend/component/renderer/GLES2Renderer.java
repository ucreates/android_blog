...
public class GLES2Renderer extends BaseRenderer {
    ...
    public boolean create(GLES2BaseModelAsset renderAsset) {
        ...
        if (GLES2BaseModelAsset.CUBE == renderAsset.type) {
        ...
        } else if (GLES2BaseModelAsset.TEXTURE == renderAsset.type) {
    ...
    public void render(GLES2BaseModelAsset renderAsset) {
        ...
        if (GLES2BaseModelAsset.CUBE == renderAsset.type) {
            ...
            GLES2TextureAsset textureAsset = (GLES2TextureAsset)renderAsset;
