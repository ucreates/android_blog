...
public class GLES2TextureAsset extends GLES2BaseModelAsset {
    private Context context;
    private String textureAssetPath;
    private int textureId;
    public GLES2TextureAsset(Context context, String textureAssetPath) {
        super(GLES2BaseModelAsset.TEXTURE);
